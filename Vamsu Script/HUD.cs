    ...
    void LateUpdate()
    {
        ...
        switch (type)
        {
            ...
            case InfoType.Health:
                mySlider.value = VamsuGameManager.instance.health / VamsuGameManager.instance.maxHealth;
                break;
            case InfoType.Gold:
                myText.text = string.Format("{0:F0}", Mathf.FloorToInt(VamsuGameManager.instance.gold));
                break;
        }
    }
}
